...
export const fleet: Aircraft[] = [
  ...
  },
  {
    ...
    specs: { range: "1,185 km", speed: "226 km/h", altitude: "14,000 ft", engines: "1 × Lycoming O-320" },
    image: "/images/fleet/cessna-172.jpg",
    highlight: {
      es: "La Cessna 172 es el avión más producido en la historia de la aviación, y por buenas razones: confiable, segura y un placer de volar, ha introducido a miles de pasajeros al mundo de la aviación privada. Su cabina de cuatro plazas —con amplias ventanas y excelente visibilidad panoramática— la convierte en la elección perfecta para vuelos escénicos sobre la Ciudad de Panamá, el Canal y las islas del Pacífico. Con su motor Lycoming O-320 y una velocidad de crucero de 226 km/h, es ideal para traslados cortos a Contadora o excursiones costeras donde la experiencia de vuelo importa tanto como el destino. Sencilla, accesible y con un historial de seguridad sin igual: la Cessna 172 es la puerta de entrada perfecta a la aviación privada.",
      en: "The Cessna 172 is the most-produced aircraft in aviation history, and for good reason: reliable, safe, and a joy to fly, it has introduced thousands of passengers to the world of private aviation. Its four-seat cabin — with large windows and excellent all-around visibility — makes it the perfect choice for scenic flights over Panama City, the Canal, and the Pacific islands. Powered by a Lycoming O-320 engine and cruising at 226 km/h, it is ideal for short transfers to Contadora or coastal excursions where the flying experience matters just as much as the destination. Simple, accessible, and with an unmatched safety record — the Cessna 172 is the perfect introduction to private aviation.",
    },
    gallery: [
      "/images/fleet/C172%20Exterior%203.jpeg",
      "/images/fleet/C172%20Interior%201.jpeg",
      "/images/fleet/C172%20Interior%202.jpeg",
    ],
  ...
  },
  {
    ...
    image: "/images/fleet/King%20ext%203.png",
    highlight: {
      es: "El King Air F90 es la aeronave ejecutiva por excelencia en la región. Sus dos motores turbohélice PT6A-135 le permiten alcanzar velocidades de crucero de hasta 500 km/h y operar a 31,000 pies de altitud —por encima del tráfico comercial y de las tormentas tropicales—, ofreciendo un vuelo suave y eficiente desde el primer minuto. Su cabina presurizada, con capacidad para 6 pasajeros en asientos de cuero con mesas de trabajo, está diseñada para que ejecutivos y empresarios lleguen a su destino descansados y listos para rendir. Con un alcance de 2,232 km, conecta Panamá con Medellín, Costa Rica y otros destinos regionales sin escalas. El King Air F90 no es solo un medio de transporte: es una herramienta de negocios.",
      en: "The King Air F90 is the executive aircraft of choice across the region. Its twin PT6A-135 turboprop engines power it to cruise speeds of up to 500 km/h at 31,000 feet — above most commercial traffic and tropical weather systems — delivering a smooth, efficient flight from the first minute. Its pressurized cabin, seating 6 passengers in individual leather chairs with work tables, is designed for business travelers who need to arrive rested and ready to perform. With a 2,232 km range, it connects Panama to Medellín, Costa Rica, and beyond without a stop. The King Air F90 is not just transportation — it is a business tool.",
    },
    gallery: [
      "/images/fleet/King%20ext%203.png",
      "/images/fleet/King%20ext%201.png",
      "/images/fleet/King%20int%201.png",
      "/images/fleet/King%20int%202.png",
    ],
